...
description: Set up the full Portr stack for local development and contribution, including the admin dashboard, tunnel server, and client CLI.
---
...
- **Admin Server**: Go/Fiber backend with a React frontend
- **Tunnel Server**: Go-based SSH/WebSocket tunnel and proxy server
