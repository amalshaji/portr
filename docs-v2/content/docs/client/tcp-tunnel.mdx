...
<Callout type="info">
  TCP tunnels are useful for exposing services like databases, WebSocket tunnel endpoints, or any service that uses raw TCP connections.
</Callout>
...
- **TCP tunneling**: Access local WebSocket tunnel endpoints from remote locations  
