---
title: Request Logs
description: Inspect locally stored HTTP request logs captured by the Portr CLI to debug, replay, and review traffic flowing through your tunnels.
---
...
Newly captured logs redact common sensitive header values such as authorization
credentials and cookies by default. Replay uses the stored header values, so
redacted headers remain redacted unless you override them during replay.
