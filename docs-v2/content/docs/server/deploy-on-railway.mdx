...
After it deploys, skip ahead to
[Add a wildcard custom domain](#add-a-wildcard-custom-domain) — that part is
manual either way. The rest of this guide sets the same thing up by hand.
