---
title: Agent Skills
description: Install the Portr CLI agent skill for Claude Code and Codex to manage teams and tunnels directly from your AI coding assistant.
---

Portr ships a `portr-cli` agent skill for using the Portr CLI with Claude Code or Codex. The skill gives agents the command map, safety notes, team-administration workflow, config shape, request-log and replay workflows, and app-server API guidance needed to operate Portr from an AI harness.
