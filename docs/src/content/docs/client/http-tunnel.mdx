...
# 🌐 Public:    https://tunnel-abc123.yourdomain.com
...
**Use cases:**
- 🛡️ Protect staging environments
...
<CardGrid>
  ...
  <Card title="🔄 Request Replay" icon="replay">
    **Replay any request**
  ...
  <Card title="📁 Request History" icon="history">
  ...
  <Card title="🛠️ Development Tools" icon="tools">
...
<CardGrid>
  <Card title="🚄 Connection Optimization" icon="speedometer">
    **Reduce latency**
  ...
  <Card title="📊 Monitoring" icon="analytics">
    **Track performance**
...
<CardGrid>
  ...
  <Card title="WebSocket Tunnels" icon="lightning">
    ...
    [WebSocket Tunnels →](/client/websocket-tunnel/)
  </Card>
