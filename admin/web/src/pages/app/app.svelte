  ...
  <span slot="sidebar">
    <div class="flex h-full max-h-screen flex-col">
      ...
      <div class="flex-1 overflow-auto py-2">
        <div class="px-3 py-2">
          <h2 class="mb-2 px-4 text-xs font-semibold tracking-tight text-gray-500 uppercase">
            Main
          </h2>
          <nav class="grid gap-1 px-2">
            ...
            <Sidebarlink url="/{team}/connections" extraClass="hover:bg-gray-100">
        ...
        <div class="px-3 py-2">
          ...
          <nav class="grid gap-1 px-2">
            ...
            <Sidebarlink url="/{team}/my-account" extraClass="hover:bg-gray-100">
        ...
        <div class="px-3 py-2">
          ...
          <nav class="grid gap-1 px-2">
            <Sidebarlink url="/{team}/email-settings" extraClass="hover:bg-gray-100">
        ...
        <div class="flex items-center p-4">
          <DropdownMenu.Root>
            ...
            <DropdownMenu.Content class="w-[200px]">
              <DropdownMenu.Item on:click={logout} class="hover:cursor-pointer text-red-600">
